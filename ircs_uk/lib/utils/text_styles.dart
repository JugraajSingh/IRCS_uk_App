...
extension styleExt on TextStyle {
  ...
  TextStyle get size13 => this.copyWith(fontSize: 13);
  ...
  TextStyle get colorWhite => this.copyWith(color: Color(0xffffffff));

  TextStyle get colorBlack => this.copyWith(color: Color(0xff000000));
